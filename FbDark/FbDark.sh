...
# Modal Dong Asw Jangan Cuman Bisa Recode Script Orang!
# Capek Gw Ngebuat Nya Bngst!
echo
echo
echo
echo $i"["$bi"•"$i"]"$me"───────────────────────────────────────────"$i"["$bi"•"$i"]"
echo $i" |"$cy"     KOPASKA CYBER TEAM ASSOCIATE"$i"         |"
echo $i" |"$me"─────────────────────────────────────────────"$i"|"
echo $i" |"$pu" AUTHOR :"$ku" MRX.L0LZ404  [K.C.T]"$i"          |"
echo $i" |"$pu" FACEBOOK :"$ku" Andrea Ferdyanzah"$i"                   |"
echo $i" |"$pu" THANKS TO :"$cy"~ [MR.503K4RN0] [Adon Healers] [Adhil]"$i"  |"
echo $i" |"$cy"            ~ [River Usu] [Diky24] [RivalRaihan]"$i" |"
echo $i" |"$pu" Contack WhatsApp :"$ku" 0895803946731"$i"             |"
echo $i" |"$pu" Contack Gmail :"$ku" Andreaferdyanzah32@gmail.com"$i"      |"
echo $i"["$bi"•"$i"]"$me"───────────────────────────────────────────"$i"["$bi"•"$i"]"
echo
echo $i"────────────────────────────────    ─────"
...
echo $i"────────────────────────────────"$i"    |"$cy" R"$i" |"
echo $i"|"$me"18"$i" |"$cy" INSTALL BAHAN DULU BNGST  "$i"|"$i"    |"$cy" E"$i" |"
echo $i"|"$me"19"$i" |"$cy" KELUAR/EXIT PROGRAM      "$i"|"$i"    |"$cy" N"$i" |"
echo $i"────────────────────────────────    ─────"
echo
echo $me"┌==="$bi"["$i"MRX.L0LZ404"$bi"]"$me"======"$bi"["$i""Pilih Nomornya""$bi"]"
echo $me"¦"
read -p"└──# " pil
...
sleep 2
echo $cy"Moga Aja Lu Tenang Di Alam Sana"
sleep 2
